...
- этап 19 — завершен: генерация рисунка и локальные тесты подтверждены пользователем;
- этап 20 — завершен: генерация рисунка и локальные тесты подтверждены пользователем;
- этап 21 — завершен: генерация рисунка и локальные тесты подтверждены пользователем;
- этап 22 — завершен: генерация рисунка и локальные тесты подтверждены пользователем;
- этап 23 — завершен: генерация рисунка и локальные тесты подтверждены пользователем;
- этап 24 — завершен: генерация рисунка и локальные тесты подтверждены пользователем;
- этап 25 — завершен: генерация рисунка и локальные тесты подтверждены пользователем;
- этап 26 — завершен: генерация рисунка и локальные тесты подтверждены пользователем;
- этап 27 — завершен: генерация рисунка, корректирующие изменения и локальные тесты подтверждены пользователем;
- этап 28 — завершен: генерация рисунка и локальные тесты подтверждены пользователем;
- этап 29 — завершен: генерация рисунка и локальные тесты подтверждены пользователем;
- этап 30 — завершен: генерация рисунка, корректирующие изменения и локальные тесты подтверждены пользователем;
- этап 31 — завершен: генерация рисунка и локальные тесты подтверждены пользователем;
- этап 32 — завершен: генерация рисунка и локальные тесты подтверждены пользователем;
- этап 33 — завершен: генерация рисунка и локальные тесты подтверждены пользователем;
- этап 34 — реализован без запуска тестов и ожидает локальной проверки пользователя.
